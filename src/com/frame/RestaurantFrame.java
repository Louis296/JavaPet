...
public class RestaurantFrame {
    ...
    private void setRestaurants(){
        ...
        taoYuan.add(new Food("精品套餐","用散粒的大米辅以精心调制的大量食用油制作而成的佳肴，火柴人吃完就会吐（不是）",0.03));
        taoYuan.add(new Food("蛋包饭","传说是wxl的最爱，但因为wxl吃的时间太长感到厌倦而被抛弃，至今wxl仍会尝试",0.07));
        taoYuan.add(new Food("卤肉饭","听起来很正常的卤肉饭，但其实里面都是玉米，玉米的甜味与卤肉的香味巧妙融合，是不可多得的佳肴（reui）",0.04));
        FoodList<Food> huiYuan=new FoodList<>("荟园");
        huiYuan.add(new Food("水饺","虽然是只有一种馅的普通水饺，但一直是华农的招牌菜，维持着众多华农学子生存的最低保障。这种普通的饺子能引来长队的奇观只会在华农看到",0.07));
        huiYuan.add(new Food("贵贵套餐","这一套餐曾在华农红极一时，但出现了不久后味道就逐渐下降。在历次更迭中更是遵遁了华农食堂一贯“去其精华，取其糟粕”的传统，而且它真的名副其实的贵",0.05));
