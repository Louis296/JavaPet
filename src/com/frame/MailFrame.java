...
public class MailFrame {
    public void go(){
        ...
        mailText.append("\n    我觉得你应该是看不到这封信的。把火柴人养到一百岁，我算了一下，按照你的性格，最快也要过个一年左右吧，这个程序能在你的电脑里撑住一年我可能就要谢天谢地了，毕竟没准他里面还藏了什么我没找出来的bug，然后程序崩溃掉了也说不定的。但如果你能看到这里，我还挺开心的，因为你有认真的在对待我给你写的东西，就像我每次都把你给我的东西小心放好一样。");
